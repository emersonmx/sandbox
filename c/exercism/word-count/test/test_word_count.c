                           ...
                           int actual_word_count)
{
    ...
    for (int index = 0; index < MAX_WORDS; index++) {
        // printf("Actual: %d %s %d\n", index, actual_solution[index].text,
        // actual_solution[index].count); printf("Expected: %d %s %d\n", index,
        // expected_solution[index].text, expected_solution[index].count);
...
static void test_max_length_word(void)
{
    ...
    int index = 0;
    char *input_text =
        "Look thisisaveeeeeerylongwordtypedwithoutusinganyspaces and look "
        "again, thisisaveeeeeerylongwordtypedwithoutusinganyspaces";
...
static void test_excessive_length_word(void)
{
    ...
    int actual_word_count;
    int index = 0;
    char *input_text = "Look "
                       "thisisanexcessivelylongwordthatsomeonetypedwithoutusing"
                       "thespacebar enough";
...
static void test_max_number_words(void)
{
    ...
    char *input_text =
        ...
        "little man who could spin straw into gold";
